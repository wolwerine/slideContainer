...
//	[self.scrollViewButtonView addSubview:deleteButton];
    ...
    label.frame = CGRectMake(0, 0, kCatchWidth, self.bounds.size.height);
    [self.scrollViewButtonView addSubview:label];
...
//    [scrollView setContentOffset:CGPointMake(-50.0f, 0)];
    
//    if ((scrollView.contentOffset.x*-1) > kCatchWidth) {
//		targetContentOffset->x = kCatchWidth*-1;
//        NSLog(@"TRUE");
//	} else {
//		*targetContentOffset = CGPointZero; //CGPointMake(kCatchWidth,kCatchWidth);
//		
//        NSLog(@"FALSE");
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (scrollView.contentOffset.x > 0.0f) {
        ...
        if (scrollView.contentOffset.x*-1 > kCatchWidth ) {
            ...
            [_delegate changeScrollViewStateWithOffset:scrollView.contentOffset.x];
